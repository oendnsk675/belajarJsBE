...
// ada beberapa kodingan yang saya buat, dengan alesan biar gak bingung, intinya saya menekankan untuk latihan dasar  kemarin
...
// 1. mengambil nama user
// const name = prompt('Nama ente siapa?: '); // fungsi ini untuk mengambil inputan user dari terminal, mirip scaner yang ada di java, kemudian di save ke variabel nama bertipe const, (gak bisa diubah)

// 2. buatlah list pilihan user, bisa memakai array ataupun objek, objek lebih saya suka karna agak panjangan dikit wkwkkw:)


// 3. tanyakan ke user mau memilih apa, untuk menanyakan ke user bisa pakek seperti di no 1, tinggal di copas honestly:) masukkan dari user itu berupa no ya temen2, karena misal nanti temen2 membuat list pilihannya itu memakai array jadi kan bisa diakses bosku......, dan tampung pilihan user tersebut ke dalam variabel dengan nama pilihan_user
